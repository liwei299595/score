...
@property(nonatomic,strong)UIButton *clearBT1;
...
//    self.addBT1.backgroundColor = [UIColor cyanColor];
    self.addBT1.font = [UIFont boldSystemFontOfSize:18];
...
//    self.addBT2.backgroundColor = [UIColor cyanColor];
    self.addBT2.font = [UIFont boldSystemFontOfSize:18];
    ...
    self.clearBT1 = [UIButton buttonWithType:UIButtonTypeSystem];
    self.clearBT1.backgroundColor = [UIColor cyanColor];
    self.clearBT1.frame = CGRectMake(self.view.bounds.size.width / 2 - 40, 340, 80, 40);
    [self.clearBT1 setTitle:@"重新开始" forState:UIControlStateNormal];
    [self.clearBT1 addTarget:self action:@selector(clearAction1) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:self.clearBT1];
